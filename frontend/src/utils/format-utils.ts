...
export const formatStock = (stock: Stock) => {
    return { ...stock, TargetFrom: formatAsMoney(stock.TargetFrom), TargetTo: formatAsMoney(stock.TargetTo),  Time: formatColombianDateTime(stock.Time)}
}